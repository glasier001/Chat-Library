...
public final class MimeUtils {
    ...
    public static final String MIME_TYPE_MEDIA = "image/* video/*";
    ...
    public static String getMediaMime() {
        return MIME_TYPE_MEDIA;
    }

    public static boolean isMimeTypeImage(String mimeType) {
        return MIME_TYPE_IMAGE.equalsIgnoreCase(mimeType);
    }

    public static boolean isMimeTypeVideo(String mimeType) {
        return MIME_TYPE_VIDEO.equalsIgnoreCase(mimeType);
    }

    public static boolean isMimeTypeMedia(String mimeType) {
        return MIME_TYPE_MEDIA.equalsIgnoreCase(mimeType);
    }

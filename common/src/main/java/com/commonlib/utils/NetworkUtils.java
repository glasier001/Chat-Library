...
public final class NetworkUtils {
    ...
    /**
     * This method us use for check device internet connected or not.
     *
     * @param context Application context
     * @return return true if device connected to internet other wise false
     */
    ...
    /**
     * Check if there is any NetworkUtils to a Wifi network
     *
     * @param context
     * @return
     */

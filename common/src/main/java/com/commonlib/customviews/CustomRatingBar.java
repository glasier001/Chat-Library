...
public class CustomRatingBar extends View {
    ...
    private void parseAttrs(AttributeSet attrs) {
        ...
        borderColor = arr.getColor(R.styleable.CustomRatingBar_srb_borderColor, ContextCompat.getColor(getContext(), R.color.ThemeColor));
  ...
  /* ----------- GETTERS AND SETTERS ----------- */
    ...
    public interface OnRatingBarChangeListener {
         ...
         */
        void onRatingChanged(CustomRatingBar simpleRatingBar, float rating, boolean fromUser);
